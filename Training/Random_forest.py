...
preprocessor = ColumnTransformer(
    transformers=[
        ('text', TfidfVectorizer(max_features=18000, ngram_range=(1,2)), 'text'),
...
# Train Random Forest with K-Fold combined learning and custom accuracy
train_with_combined_kfold_mae(
    RandomForestClassifier(
        ...
        random_state=42,
        n_jobs=-1
    ), r".\Dataset\part2.csv", "Random Forest")
